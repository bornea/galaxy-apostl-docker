shinyUI(
  ...
  tabsetPanel(type="pills",
    ################################# ABOUT PANEL ##############################
    tabPanel("About",img(src="APOSTL_icon.png", height = 100, width = 150)),
    tabPanel("QC: Replicate Correlations",
    ...
    tabPanel("Histogram",
             ...
             selectInput("hist.x", "Select X Axis", selected="log2(FoldChange)",choices=c("ln(NSAF)","SpecSum", "log2(FoldChange)", "SaintScore", "logOddsScore", "-log10(BFDR)")),
